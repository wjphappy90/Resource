...
public class ProductDAOImpl implements IProductDAO {
	...
	public int findAllCount() throws Exception {
		QueryRunner runner = new QueryRunner(JdbcUtils.getDataSource());
		return ((Long) runner.query("select count(1) from product", new ScalarHandler())).intValue();
	}

	// 分页查询数据
	@Override
	public List<Product> findByPage(int pageNum, int pageSize) throws Exception {
		QueryRunner runner = new QueryRunner(JdbcUtils.getDataSource());
