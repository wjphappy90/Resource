										...
										<TABLE id=grid style="BORDER-TOP-WIDTH: 0px; FONT-WEIGHT: normal; BORDER-LEFT-WIDTH: 0px; BORDER-LEFT-COLOR: #cccccc; BORDER-BOTTOM-WIDTH: 0px; BORDER-BOTTOM-COLOR: #cccccc; WIDTH: 100%; BORDER-TOP-COLOR: #cccccc; FONT-STYLE: normal; BACKGROUND-COLOR: #cccccc; BORDER-RIGHT-WIDTH: 0px; TEXT-DECORATION: none; BORDER-RIGHT-COLOR: #cccccc" cellSpacing=1 cellPadding=2 rules=all border=0>
											<TBODY>
												...
												<TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													...
													&nbsp;&nbsp;
													<a href="#" onclick="delOne('${customer.custId}')">删除</a>
												...
												<TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													...
													&nbsp;&nbsp;
													<a href="#" onclick="delOne('<s:property value="#cust.custId"/>')">删除</a>
													<a href="javascript:delOne('<s:property value="#cust.custId"/>')" >删除</a>
													</TD>
												</TR>	
												</s:iterator> --%>
												<s:iterator value="customers">
													...
													<TD>
													<a href="${ pageContext.request.contextPath }/customer/CustomerServlet?method=editCustomerUI&custId=<s:property value='custId'/>">修改</a>
													&nbsp;&nbsp;
													<a href="#" onclick="delOne('<s:property value="custId"/>')">删除</a>
													<a href="javascript:delOne('<s:property value="custId}"/>" >删除</a>
													</TD>
												</TR>	
												</s:iterator>
											</TBODY>
