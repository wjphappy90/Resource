					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3">
									<s:select name="customer.custId" list="customers" listKey="custId" listValue="custName" headerKey="" headerValue="---请选择---" class="textbox" id="sChannel2" style="WIDTH: 180px" maxLength="50"/>
								</td>
							</tr> 
							<TR>
								<td>联系人名称：</td>
