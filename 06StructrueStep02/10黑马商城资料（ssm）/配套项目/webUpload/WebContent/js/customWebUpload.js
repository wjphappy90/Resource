$(function() {
	...
	var uploader = WebUploader.create({
		...
		swf : 'Uploader.swf',
		// 文件接收服务端。
		server : '/webUpload/upload/webUpLoaderPicture.do',
	...
	uploader .on('uploadProgress',
		function(file, percentage) {
			...
			// 避免重复创建
			if (!$percent.length) {
				$percent = $('<div class="progress-box"><span class="progress-bar radius"><span class="sr-only" style="width:0%"></span></span></div>')
